...
mirror/offline bundle, fault matrix, SBOM, device-enablement, health-attestation, audit, release-gate, bootstrap-adapter, recovery-proof, package-admission, storage-layout, device-matrix, reproducible-build, and USB Installer dry-run reference tooling
