...
mirror/offline bundle, fault matrix, SBOM, device-enablement, health-attestation, audit, release-gate, bootstrap-adapter, and recovery-proof reference tooling
